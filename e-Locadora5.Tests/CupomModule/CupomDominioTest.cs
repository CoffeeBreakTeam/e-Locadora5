...
namespace e_Locadora5.Tests.CupomModule
{
    ...
    public class CupomDominioTest
    {
        ...
        public void Deve_Validar_Cupons()
        {
            ...
            Cupons cupons = new Cupons("Deco-5630", 0, 120,(new DateTime(2021,08,27)), parceiro,2300);
        ...
        {
            Parceiro parceiro = new Parceiro("Deko");
            Cupons cupons = new Cupons("", 0, 120, (new DateTime(2021, 08, 27)), parceiro,1200);
        ...
        {
            Parceiro parceiro = new Parceiro("Deko");
            Cupons cupons = new Cupons("Deco-5630", -1, 0, (new DateTime(2021, 08, 27)), parceiro,1200);
        ...
        {
            Parceiro parceiro = new Parceiro("Deko");
            Cupons cupons = new Cupons("Deco-5630", 0, -1, (new DateTime(2021, 08, 27)), parceiro,1200);
        ...
        {
            Parceiro parceiro = new Parceiro("Deko");
            Cupons cupons = new Cupons("Deco-5630", 0, 20, DateTime.MinValue, parceiro,1200);
        ...
        {
            Parceiro parceiro = new Parceiro("Deko");
            Cupons cupons = new Cupons("Deco-5630", 120, 0, new DateTime(2021, 08, 27), parceiro, 150);
